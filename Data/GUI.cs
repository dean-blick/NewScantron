...
{
    class GUI
    {///////////////////////////////////////////DO NOT IMPLEMENT THIS CLASS!! this class is for storing old code until the program is functional and then it will be deleted.
        /*
        ...
        namespace Scantron
        {
            public class GUI
            {
                ...
                //private NumericUpDown uxNumberOfSheetsNumericUpDown;
                ...
                public int number_of_questions = 0;
                ...
                private void InitializeInstructionText()
                {
                    uxStartInstructionLabel.Text = "Welcome to the new Scantron program!"
                                                            ...
                                                            "1. Set your Scantron cards in the tray by following the pictures to the right. Do not fill the tray higher than the maximum line. You can add more sheets later." + Environment.NewLine + Environment.NewLine +
                    ...
                    uxScanInstructionLabel.Text =           "1. If the display on the machine is blank, hold the power button until the machine is on. Click the button labeled \"Start\" on the Scantron Machine. The machine should say \"Waiting for Computer\". Click the ready button below." + Environment.NewLine + Environment.NewLine +
                                                            "2. Once the machine is no longer making noise, if you have more sheets, go to step 3. If you have no more sheets, step 4." + Environment.NewLine + Environment.NewLine +
                                                            "3. To add more sheets, place them in the tray as shown, press down the \"press to load\" button and release it, then press start and the machine will begin scanning again. You can repeat this step until you are out of sheets." + Environment.NewLine + Environment.NewLine +
                                                            "4. Click done below and you should see the information representing each card on the right. Please ensure all of the cards you scanned appear on the right." + Environment.NewLine + Environment.NewLine +
                                                            "5. Click Save Changes, then click Continue.";
                        ...
                        foreach (Card card in grader.Cards)
                        {
                            ...
                            for (int i = 0; i < card.Response.Count; i++)
                            {
                                ...
                                for (int j = 0; j < 5; j++)
                                {
                                    ...
                                    if (card.Response[i].Answer[j] > 50)
                                    {
                ...
                public void Ready()
                {
                    ...
                    if(number_of_versions == 0 || number_of_questions == 0)
                    {
                        DisplayMessage("You have not specified the number of versions/questions/sheets. Go back to the Start tab and follow the instructions.");
                        return;
                    }
                ...
                public void Done()
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        DisplayMessage("Something went wrong. Do not click Done while the machine is running. " +
                                        "Reload the last sheet/sheets, press the loading button, click start on the machine, click Ready, and begin scanning again.");
                    }
                }
                ...
                private void DisplayStudent(Student student)
                {
                    ...
                    for (int i = 0; i < Math.Min(grader.AnswerKey[test_version - 1].Count, student.Response.Count); i++)
                    {
                        ...
                        for (int j = 0; j < 5; j++)
                        {
                            ...
                            if (student.Response[i].Answer[j] < 54)
                            {
                ...
                public void WriteFile(string type)
                {
                    ...
                    if (type == "single")
                    {
                        file = grader.SingleAnswerFile(number_of_questions);
                    }
                    if (type == "multiple")
                    {
                ...
                public void guiTestFunc(string input)
                {
                    scanner.TestFunc(input);
                }
            }
            }
